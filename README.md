...
| [![kitty](https://img.shields.io/badge/kitty-1F1F1F?style=flat-square)](https://github.com/kovidgoyal/kitty/pulls?q=is%3Apr+author%3A4RH1T3CT0R7+is%3Amerged) | Three changes: fuzzy search in the themes and fonts kittens no longer freezes on long queries (28 s to 0.2 ms), the diff kitten's word diff no longer builds gigabyte tables on long lines, and `save_as_session` reports an error for a directory |
...
| [![kitty](https://img.shields.io/badge/kitty-1F1F1F?style=flat-square)](https://github.com/kovidgoyal/kitty/pulls?q=is%3Apr+author%3A4RH1T3CT0R7+is%3Amerged) | Три правки: нечёткий поиск в киттенах тем и шрифтов больше не зависает на длинных запросах (28 с → 0,2 мс), пословный diff не строит гигабайтные таблицы на длинных строках, `save_as_session` сообщает об ошибке для папки |
